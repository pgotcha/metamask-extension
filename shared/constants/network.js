...
export const GOTCHA_NETWORK_ID = '3';
...
export const GOTCHA_CHAIN_ID = '0x3';
...
export const GOTCHA_DISPLAY_NAME = 'Gotcha';

const infuraProjectId = process.env.INFURA_PROJECT_ID;
const getRpcUrl = (network) =>
  `https://${network}.infura.io/v3/${infuraProjectId}`;

const getRpcUrlEntryPoint = () => 'http://dev.wegotcha.io:8546';

// export const ROPSTEN_RPC_URL = getRpcUrlEntryPoint();
export const ROPSTEN_RPC_URL = getRpcUrlEntryPoint('ropsten');
...
export const GOTCHA_RPC_URL = getRpcUrlEntryPoint();
...
export const NETWORK_TYPE_TO_ID_MAP = {
  ...
  [GOTCHA]: { networkId: GOTCHA_NETWORK_ID, chainId: GOTCHA_CHAIN_ID },
};
...
export const NETWORK_TO_NAME_MAP = {
  ...
  [GOTCHA_NETWORK_ID]: GOTCHA_DISPLAY_NAME,
  ...
  [GOTCHA_CHAIN_ID]: GOTCHA_DISPLAY_NAME,
};
...
export const CHAIN_ID_TO_RPC_URL_MAP = {
  ...
  [GOTCHA_CHAIN_ID]: GOTCHA_RPC_URL,
};
